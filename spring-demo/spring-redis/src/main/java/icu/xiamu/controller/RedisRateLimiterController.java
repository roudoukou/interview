...
import icu.xiamu.limit.LimitType;
...
public class RedisRateLimiterController {
    ...
    public R<String> test(String value) {
        return R.ok("操作成功" + new Random().nextInt(10), value);
    }
     ...
     * 启动两个后端服务互不影响
     */
    @RateLimiter(count = 1, time = 1, limitType = LimitType.CLUSTER)
     ...
     */
    @RateLimiter(count = 1, time = 1, limitType = LimitType.IP, key = "#value")
    @GetMapping("/testObj")
