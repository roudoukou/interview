...
public class ConfigTest {
    ...
    public void test13() {
        ...
        // 支持传递多个值
        context1.getEnvironment().setActiveProfiles("prod", "dev");
        context1.register(MyConfigOfProfile.class);
        context1.refresh();
        System.out.println(Arrays.toString(context1.getBeanNamesForType(DataSource.class)));
